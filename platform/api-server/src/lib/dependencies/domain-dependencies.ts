...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/addressing\//, domain: "addressing" },
  { pattern: /\/fl\//, domain: "fl" },
  { pattern: /\/identity\//, domain: "identity" },
  { pattern: /\/jobs\//, domain: "jobs" },
  { pattern: /\/protocol\//, domain: "protocol" },
  { pattern: /\/provenance\//, domain: "provenance" },
  { pattern: /\/sites\//, domain: "sites" },
  { pattern: /\/tiers\//, domain: "tiers" },
  { pattern: /\/trust\//, domain: "trust" },
];
...
export async function injectDomainDependencies(
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "addressing":
        domainDeps = buildAddressingDomainModule(dynamoClient);
        break;
      case "fl":
        domainDeps = buildFlDomainModule(dynamoClient);
        break;
      case "identity":
        domainDeps = buildIdentityDomainModule(dynamoClient);
        break;
      case "jobs":
        domainDeps = buildJobsDomainModule(dynamoClient);
        break;
      case "protocol":
        domainDeps = buildProtocolDomainModule(dynamoClient);
        break;
      case "provenance":
        domainDeps = buildProvenanceDomainModule(dynamoClient);
        break;
      case "sites":
        domainDeps = buildSitesDomainModule(dynamoClient);
        break;
      case "tiers":
        domainDeps = buildTiersDomainModule(dynamoClient);
        break;
      case "trust":
        domainDeps = buildTrustDomainModule(dynamoClient);
        break;
      default:
        return;
    }
...
export interface DomainDependencies {
  addressing: AddressingDomainModule;
  fl: FlDomainModule;
  identity: IdentityDomainModule;
  jobs: JobsDomainModule;
  protocol: ProtocolDomainModule;
  provenance: ProvenanceDomainModule;
  sites: SitesDomainModule;
  tiers: TiersDomainModule;
  trust: TrustDomainModule;
}
 ...
 */
export function getAddressingDeps(
  request: FastifyRequest,
): DomainDependencies["addressing"] {
  return getDomainDeps(request, "addressing");
}
export function getFlDeps(
  request: FastifyRequest,
): DomainDependencies["fl"] {
  return getDomainDeps(request, "fl");
}
...
export function getJobsDeps(
  request: FastifyRequest,
): DomainDependencies["jobs"] {
  return getDomainDeps(request, "jobs");
}
export function getProtocolDeps(
  request: FastifyRequest,
): DomainDependencies["protocol"] {
  return getDomainDeps(request, "protocol");
}
...
export function getSitesDeps(
  request: FastifyRequest,
): DomainDependencies["sites"] {
  return getDomainDeps(request, "sites");
}
export function getTiersDeps(
  request: FastifyRequest,
): DomainDependencies["tiers"] {
  return getDomainDeps(request, "tiers");
}
export function getTrustDeps(
  request: FastifyRequest,
): DomainDependencies["trust"] {
  return getDomainDeps(request, "trust");
}
