/**
 * Protocol Services - Application Layer Export
 *
...
/**
 * Protocol Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for protocol domain.
 */
