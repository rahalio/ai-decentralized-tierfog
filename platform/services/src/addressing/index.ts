/**
 * Addressing Services - Application Layer Export
 *
...
/**
 * Addressing Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for addressing domain.
 */
