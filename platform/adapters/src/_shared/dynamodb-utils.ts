 ...
 *
 * @returns The core table name (e.g., "tierfog-core-dev")
 ...
 *
 * @returns The base table name (e.g., "tierfog-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "tierfog-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "tierfog-app-realtime-dev")
